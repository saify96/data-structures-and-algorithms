...
const addValues = (arr) => {
  // Solution code here...
  return arr.reduce((accumulator, value) => accumulator = accumulator + value, 0);
};
...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((acc, price) => acc += price.purchasePrice, 0);
};
...
const returnNames = (arr) => {
  // Solution code here...
  const starsName =[];
  arr.reduce((acc,stars)=>starsName.push(stars.name),'');
  return starsName;
};
