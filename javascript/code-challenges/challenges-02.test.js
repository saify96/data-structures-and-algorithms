...
const raisedToTheThird = (arr) => {
  // Solution code here...
  const newArr =[];
  arr.forEach((power)=>newArr.push(Math.pow(power,3)));
  return newArr;
};
...
const addOne = (arr) => {
  // Solution code here...
 const newArr = arr.map((add)=>add +1)
      return newArr;   
};
...
const addQuestion = (arr) => {
  // Solution code here...
  const newArr = arr.map((ques)=>ques +'?')
  return newArr;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  const newArr=[];
  arr.forEach((power)=>newArr.push(Math.pow(2,power)))
  return newArr;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  const newArr = arr.map((power)=>Math.pow(2,power))
  return newArr;
